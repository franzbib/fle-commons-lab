...
export const demoResources: Resource[] = [
  ...
  },
  {
    ...
    summary:
      'Fiche B1 de grammaire inductive prete a copier ou imprimer: enquete fictive, observation guidee, transformations COD/COI, guide professeur et corrige separe.',
    level: 'B1',
    durationMinutes: 90,
    durationCategory: '60_120_min',
    mainSkill: 'grammaire',
    ...
    theme: 'Enquete',
    lexicalThemes: ['temoignage', 'objets trouves', 'suspects', 'indices'],
    ...
    license: 'CC_BY_SA',
    authors: ['Equipe demo FLE'],
    tags: ['pronoms', 'COD', 'COI', 'enquete', 'fiche etudiant', 'corrige inclus'],
    materialNeeded: ['fiche apprenant imprimee ou projetee', 'tableau'],
    sourceType: 'document_cree',
    teacherPreparationLevel: 'faible',
    preparationAlerts: [
      {
        type: 'impression',
        label: 'Fiche apprenant a imprimer ou projeter',
        detail:
          'Prevoir une copie apprenant sans le corrige; le guide professeur et le corrige restent dans l onglet enseignant.',
      },
      {
        type: 'vigilance',
        label: 'Ne pas melanger COD et COI',
        detail:
          'Faire verbaliser la construction du verbe: appeler quelqu un, mais telephoner a quelqu un.',
      },
    ],
    ...
    content: {
      objectives: {
        title: 'Objectifs',
        items: [
          'Identifier un complement direct et un complement introduit par a.',
          'Choisir entre le, la, les, lui et leur dans des phrases d enquete.',
          'Transformer des phrases courtes en utilisant un pronom COD ou COI.',
          'Reutiliser les pronoms dans un court echange entre enqueteur et temoin.',
        ],
      },
      prerequisites: {
        title: 'Pre-requis',
        items: [
          'Connaitre les pronoms le, la, les, lui et leur au moins en reconnaissance.',
          'Savoir reperer un verbe et son complement dans une phrase simple.',
          'Avoir deja travaille quelques verbes frequents: voir, chercher, appeler, parler a, repondre a, donner a.',
        ],
      },
      lessonPlan: {
        title: 'Deroule',
        items: [
          '10 min: presenter la situation d enquete et lire le mini-dialogue.',
          '15 min: faire relever les pronoms et les mots qu ils remplacent.',
          '15 min: construire au tableau deux colonnes: COD direct / COI avec a.',
          '20 min: faire les transformations en binomes, puis corriger par justification.',
          '15 min: faire l exercice de choix entre le, la, les, lui et leur.',
          '15 min: terminer par un mini-dialogue d enquete avec deux pronoms COD et deux pronoms COI.',
        ],
      },
      studentInstructions: {
        ...
        items: [
          'Situation',
          'Dans une ecole de langue, un badge visiteur a disparu apres la pause. Lina, la responsable de l accueil, interroge trois personnes: Sami, Nora et Hugo.',
          'Mini-dialogue',
          'Lina: Tu as vu le badge ce matin ?',
          'Sami: Oui, je l ai vu sur la table pres de la porte.',
          'Lina: Tu as parle a Nora pendant la pause ?',
          'Sami: Oui, je lui ai parle deux minutes. Elle cherchait son sac.',
          'Nora: Je n ai pas pris le badge. J ai appele Hugo parce qu il rangeait la salle.',
          'Hugo: Lina m a donne la cle du placard, mais elle ne m a pas donne le badge. Je l ai retrouve plus tard sous une chaise.',
          'Observation guidee',
          'Relevez les pronoms complements dans le dialogue: l, lui, m, le, la, les si vous en trouvez.',
          'Pour chaque pronom, indiquez le mot ou la personne qu il remplace.',
          'Classez les exemples en deux colonnes: le pronom remplace un complement direct / le pronom remplace une personne introduite par a.',
          'Exercice 1: reperage',
          'Dans les phrases suivantes, soulignez le complement a remplacer: Lina cherche le badge. Lina parle a Sami. Nora appelle Hugo. Hugo repond a Lina.',
          'Exercice 2: transformation',
          'Transformez avec le, la ou les: Lina cherche le badge. Sami regarde la table. Nora appelle Hugo. Les etudiants observent les indices.',
          'Transformez avec lui ou leur: Lina parle a Sami. Hugo repond a Lina. Nora telephone aux responsables. Lina donne une consigne aux temoins.',
          'Exercice 3: choisir le bon pronom',
          'Completez: Tu vois le badge ? Oui, je ___ vois.',
          'Tu parles a Sami ? Oui, je ___ parle.',
          'Nora appelle Hugo ? Oui, elle ___ appelle.',
          'Hugo repond aux responsables ? Oui, il ___ repond.',
          'Lina donne la cle a Hugo ? Oui, elle ___ donne la cle.',
          'Petit bilan grammatical',
          'Le, la, les remplacent souvent une personne ou une chose directement apres le verbe: je vois le badge -> je le vois.',
          'Lui et leur remplacent une personne introduite par a: je parle a Sami -> je lui parle.',
          'Attention: une personne peut etre COD ou COI. Je vois Sami -> je le vois. Je parle a Sami -> je lui parle.',
          'Reemploi court',
          'En binomes, ecrivez six repliques entre un enqueteur et un temoin. Utilisez au moins deux pronoms COD, deux pronoms COI et une phrase au passe compose.',
        ],
      },
      teacherGuide: {
        title: 'Guide professeur',
        items: [
          ...
          'Cette fiche sert a stabiliser une confusion frequente au niveau B1: choisir le pronom selon la construction du verbe, pas seulement selon personne ou chose.',
          'Deroule minute',
          '0-10 min: installer le scenario et lire le dialogue une fois sans expliquer toute la grammaire.',
          '10-25 min: reperage en binomes, puis mise en commun des pronoms et de leurs references.',
          '25-40 min: formalisation au tableau avec deux questions: le verbe prend-il un complement direct ? le verbe se construit-il avec a ?',
          '40-75 min: exercices de transformation et de choix, correction apres chaque bloc.',
          '75-90 min: mini-dialogue d enquete, puis correction orale de deux exemples produits par le groupe.',
          'Points de vigilance',
          ...
          'Faire memoriser quelques constructions utiles: appeler quelqu un, chercher quelque chose, parler a quelqu un, repondre a quelqu un, donner quelque chose a quelqu un.',
          'Pour un groupe B1 fragile, reduire le nombre de phrases et garder la liste des verbes visibles pendant les exercices.',
          'Pour un groupe plus avance, demander aux apprenants de justifier chaque pronom avec la construction du verbe.',
          'Erreurs frequentes',
          'Utiliser lui apres appeler: il lui appelle au lieu de il l appelle.',
          'Utiliser le/la apres telephoner ou repondre: je le telephone au lieu de je lui telephone.',
          'Oublier que donner quelque chose a quelqu un peut garder la chose dans la phrase: elle lui donne la cle.',
        ],
      },
      answerKey: {
        title: 'Corrige',
        items: [
          ...
          'lui dans je lui ai parle remplace a Nora: COI.',
          'm dans Lina m a donne la cle remplace a moi / a Hugo: COI.',
          'm dans elle ne m a pas donne le badge remplace a moi / a Hugo: COI.',
          'l dans je l ai retrouve remplace le badge: COD.',
          'Exercice 1: reperage',
          'Lina cherche le badge: le badge est COD.',
          'Lina parle a Sami: a Sami est COI.',
          'Nora appelle Hugo: Hugo est COD, car appeler quelqu un se construit directement.',
          'Hugo repond a Lina: a Lina est COI.',
          ...
          'Oui, elle l appelle.',
          'Oui, il leur repond.',
          'Oui, elle lui donne la cle.',
          'Justifications rapides',
          'Appeler quelqu un -> COD: je l appelle.',
          'Parler a quelqu un, repondre a quelqu un, telephoner a quelqu un -> COI: je lui parle, je lui reponds, je lui telephone.',
          'Donner quelque chose a quelqu un -> si on remplace la personne, on utilise lui ou leur.',
          'Reemploi: accepter les dialogues coherents qui contiennent au moins deux COD, deux COI et une phrase au passe compose.',
        ],
      },
      variants: {
        title: 'Variantes',
        items: [
          ...
          'Version plus difficile: ajouter deux phrases avec un double complement sans demander de double pronominalisation.',
          'Version generique: remplacer ecole de langue, badge, Lina, Sami, Nora et Hugo par un lieu, un objet et des prenoms choisis par la classe.',
          'Version orale: distribuer trois roles fictifs et faire improviser l interrogatoire apres les exercices.',
        ],
      },
      usageNotes: {
        title: "Retours d'usage",
        items: [
          'Retour simule: testable en 90 minutes avec un groupe B1 de 10 a 14 apprenants.',
          'Ce qui devrait fonctionner: le scenario d enquete donne une raison de repeter les memes verbes sans rendre l exercice trop mecanique.',
          'Difficulte probable: la phrase donner quelque chose a quelqu un demande une justification lente.',
          'Ajustement conseille: retirer deux phrases de transformation si le groupe manque d aisance a l ecrit.',
        ],
      },
    },
    versions: [
      {
        ...
        versionNumber: '1.0',
        label: 'ressource demo etalon',
        changelog: [
          'Creation d une ressource interne structurée pour tester fiche apprenant, guide professeur, corrige, copie et impression.',
        ],
        createdAt: '2026-05-25',
        createdBy: 'Equipe demo FLE',
        status: 'utilisable',
    ...
    usageFeedbacks: [
      {
        ...
        context: 'Groupe B1 adultes, revision des pronoms complements',
        actualDurationMinutes: 88,
        groupLevel: 'B1',
        whatWorked:
          'Les apprenants comprennent vite pourquoi le meme personnage peut etre remplace par le ou lui selon le verbe.',
        difficulties:
          'Les phrases avec donner quelque chose a quelqu un demandent une correction lente.',
        suggestedChanges:
    ...
    reviewSummary: {
      ...
      digitalReadinessScore: 2,
      strengths: [
        'Fiche apprenant, guide professeur et corrige clairement separes',
        'Progression observation, transformation, choix puis reemploi',
        'Contexte fictif juridiquement sur et facile a adapter',
      ],
      issues: [
        'La distinction COD/COI reste exigeante pour un B1 fragile',
        'Les phrases avec donner quelque chose a quelqu un doivent etre corrigees lentement',
      ],
      recommendations: [
        'Tester la fiche avec deux groupes B1 differents avant de la marquer comme validee',
        'Preparer une version allegee si le groupe a peu de metalangage grammatical',
      ],
    },
    techMetadata: {
      usesDigitalTool: false,
    ...
    aiMetadata: {
      ...
      studentFacingAI: false,
      risks: [],
      safeguards: ['Aucun usage IA prevu pour cette ressource.'],
    },
  },
  {
